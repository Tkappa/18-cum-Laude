...
main: build/main.o build/Controller.o build/Character.o build/MajorCharacter.o build/Follower.o build/Mappa.o build/View.o build/Stanza.o build/ability.o
